...
export declare const TextureSamplingMode: {
    NEAREST: number;
    BILINEAR: number;
    TRILINEAR: number;
};
export declare const TextureWrapping: {
    CLAMP: number;
    WRAP: number;
    MIRROR: number;
};
export declare type IBillboardModes = 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7;
export declare const TransparencyModes: {
    OPAQUE: number;
    ALPHATEST: number;
    ALPHABLEND: number;
    ALPHATESTANDBLEND: number;
};
export declare type ITransparencyModes = 0 | 1 | 2 | 3;
...
export interface ILand extends APILand {
    scene: IScene;
    baseUrl: string;
    html?: string;
